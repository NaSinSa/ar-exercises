...
@store1.employees.create(first_name: "dd", last_name: "bee", hourly_rate: 40)
@store2.employees.create(first_name: "zaa", last_name: "dee", hourly_rate: 105)
@store2.employees.create(first_name: "raa", last_name: "vee", hourly_rate: 200)
